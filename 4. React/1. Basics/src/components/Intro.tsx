...
export const Intro = () => {
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <p className="text-gray-700 leading-relaxed text-lg">
        React Hooks are special functions that let you use state, lifecycle
        methods, and other React features in functional components without
        writing classes. The most commonly used hooks are:
        <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-1">
          <li>
            <code>useState</code>
          </li>
